...
tags: java service procrun jsvc hsqldb 
---
...
Текущая задача организовать службу Windows, поэтому обратим наш взор  на [Procrun](http://commons.apache.org/daemon/procrun.html). В архиве из раздела загрузок есть два главных для нас файла: __prunsrv.exe__ и __prunmgr.exe__. Первый это тот самый файл, обеспечивающий интеграцию со средствами ОС, а второй - несложная утилита управления.
